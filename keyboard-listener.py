...
KEY_COMMANDS = {
    ecodes.KEY_SPACE: "debug_toggle",
    ecodes.KEY_D: "debug_toggle",
    ecodes.KEY_UP: "threshold_up",
    ecodes.KEY_DOWN: "threshold_down",
    ecodes.KEY_RIGHT: "timeout_up",
    ecodes.KEY_LEFT: "timeout_down",
